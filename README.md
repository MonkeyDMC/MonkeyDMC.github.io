...
<script async src="https://www.googletagmanager.com/gtag/js?id=G-SYX5RJWJ0W"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-SYX5RJWJ0W');
</script>
...
<!--  -->
  ...
  <div class="col mb-4">
    <div class="card">
      <img src="images/Pic/kirii.jpg" class="card-img-top" alt="Кирии">
      <div class="card-body">
